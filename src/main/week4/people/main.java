...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        people.Teacher pekkaTeacher = new people.Teacher("Pekka Mikkola", "Korsontie Street 1 03100 Vantaa", 1200);
        people.Teacher eskoTeacher = new people.Teacher("Esko Ukkonen", "Mannerheimintie Street 15 00100 Helsinki", 5400);
